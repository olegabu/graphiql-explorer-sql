...
export const GRAPH_QL_SUBSCRIPTION_URL = process.env.REACT_APP_GRAPH_QL_SUBSCRIPTION_URL || `${isHttps ? 'wss' : 'ws'}://${GRAPH_QL_URL.split('://')[1]}`;
export const SQL_QUERY_URL = process.env.REACT_APP_SQL_QUERY_URL || 'http://localhost:8080/sql-query';
export const DEFAULT_SQL_QUERY = process.env.REACT_APP_DEFAULT_SQL_QUERY || 'select * from customers';
